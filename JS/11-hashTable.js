...
class HashTable {
  constructor(size = 53) { this.keyMap = Array.from({ length: size }, () => []); }
  _hash(k) { return hash(k, this.keyMap.length); }
  set(key, val) {
...
ht.set("Java", "I love Java").set("Rust", "Rust is cool").set("JS", "JS is everywhere");
